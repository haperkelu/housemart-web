 ...
 * @author pqin
 */
public class HouseAuditHistoryEntity {
	private Integer id;
  ...
  public String getHouseCreatorName() {
    return houseCreatorName;
  }
  public void setHouseCreatorName(String houseCreatorName) {
    this.houseCreatorName = houseCreatorName;
  }
