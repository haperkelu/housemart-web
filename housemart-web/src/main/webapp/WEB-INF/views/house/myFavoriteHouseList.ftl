<html>
	...
	<body>
		<div>
			<form action="/myFavoriteHouseList.controller" method="get" id="houseListForm" enctype="x-www-form-urlencoded" onsubmit="$('#residenceName').val(encodeURI($('#residenceName').val()))">
